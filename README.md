...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/IntroductionToBlitz
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/IntroductionToBlitz_test
```
